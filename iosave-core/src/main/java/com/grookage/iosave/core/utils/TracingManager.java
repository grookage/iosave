...
public class TracingManager {
  ...
  private static final ThreadLocal<String> tracingContext = new ThreadLocal<>();

  public static void startTracing(String transactionId) {
    tracingContext.set(transactionId);
  }
